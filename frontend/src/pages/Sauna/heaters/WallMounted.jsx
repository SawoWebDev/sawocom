...
const wallProducts = productsData.filter((p) =>
  p.categories?.includes("Wall-Mounted"),
);

const groupedProducts = wallProducts.reduce((groups, product) => {
...
// Ordered group names — only include groups that have products
      ...
      <section className="wm-section">
        <div className="wm-container text-center">
          ...
          <p className="wm-products-desc">
            Our wall-mounted heaters are crafted for those who love the traditional dry and hot sauna
            experience. This series of classic heaters boasts of robust, space-saving models for small
            and medium-sized saunas. For added safety, some models feature cool-to-touch fibercoating
