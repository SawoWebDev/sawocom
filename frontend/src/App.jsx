...
// Dynamic product detail page (single template for all products)
...
export default function App() {
  return (
    // ThemeProvider must be the outermost wrapper so its injected CSS vars
    // are available to EVERY page — public and admin alike.
    <ThemeProvider>
      <Router>
        <Routes>
          ...
          <Route path="*" element={
            <MainLayout>
              <Routes>
                ...
                {/* Single product detail page — one template used for every product */}
